...
/**
 * Todas las rutas de analytics requieren rol de admin
 */
 ...
 */
router.get('/reports/pending', requireAdmin, async (req, res) => {
  try {
 ...
 */
router.put('/reports/:id/validate', requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/reports/clusters', requireAdmin, async (req, res) => {
  try {
 ...
 */
router.post('/cluster/run', requireAdmin, async (req, res) => {
  try {
 ...
 */
router.post('/cluster/recalculate', requireAdmin, async (req, res) => {
  try {
 ...
 */
router.get('/cluster/candidates/:id', requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
